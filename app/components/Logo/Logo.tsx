...
const Logo = () => {
  ...
  return (
    <Link href="/" >
    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="47" fill="none" id={style.logoSmall} ref={logoRef} onMouseEnter={handleMouseEnter}
      ...
      <path
        ...
        d="M23.998 20.711a.832.832 0 0 1-.383-.568.827.827 0 0 1 .081-.68l7.832-13.095c.822-1.376 1.889-2.404 3.2-3.063 1.306-.656 2.742-.905 4.292-.756h.003c1.522.157 3.026.71 4.508 1.64 1.519.953 2.702 2.086 3.531 3.406.829 1.32 1.252 2.727 1.255 4.209v.003c-.01 1.498-.434 2.937-1.255 4.311l-1 1.672-.096.134a.808.808 0 0 1-.432.266l-.086.017a.884.884 0 0 1-.608-.126l-4.003-2.512a.832.832 0 0 1-.382-.564.828.828 0 0 1 .08-.684l.983-1.643c.42-.702.531-1.36.389-1.997-.15-.604-.555-1.144-1.295-1.609-.7-.439-1.365-.572-2.015-.445-.65.143-1.177.532-1.589 1.22l-7.814 13.067a.836.836 0 0 1-.527.4.896.896 0 0 1-.695-.108l-3.974-2.495Z"
      />
    </svg>
    </Link>
  );
